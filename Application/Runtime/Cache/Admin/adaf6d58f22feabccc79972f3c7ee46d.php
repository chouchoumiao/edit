...
<body class="login login-action-lostpassword wp-core-ui  locale-zh-cn">
	<div id="login">
            <h1><a tabindex="-1" title="ZanBlog" href="http://localhost/NewWordpress">稿库系统</a></h1>
        <p class="message">请输入您的用户名或电子邮箱地址。您会收到一封包含创建新密码链接的电子邮件。</p>

        <form method="post" action="http://localhost/NewWordpress/wp-login.php?action=lostpassword" id="lostpasswordform" name="lostpasswordform">
            <p>
                <label for="user_login">用户名或电子邮件地址<br>
                <input type="text" size="20" value="" class="input" id="user_login" name="user_login"></label>
            </p>
                <input type="hidden" value="" name="redirect_to">
            <p class="submit"><input type="submit" value="获取新密码" class="button button-primary button-large" id="wp-submit" name="wp-submit"></p>
        </form>
